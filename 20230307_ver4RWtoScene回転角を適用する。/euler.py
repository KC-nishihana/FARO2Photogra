...
def Rodrigues(vecx,vecy,vecz,theta):
    """
    ロドリゲスの回転行列。
    ------------------------------
    vecP : array-like
    ...
    # 回転行列の成分
    R11 = c+(1-c)*vecx**2
    R12 = vecx*vecy*(1-c)-vecz*s
    R13 = vecx*vecz*(1-c)+vecy*s
    R21 = vecx*vecy*(1-c)+vecz*s
    R22 = c+(1-c)*vecy**2
    R23 = vecy*vecz*(1-c)-vecx*s
    R31 = vecx*vecz*(1-c)-vecy*s
    R32 = vecy*vecz*(1-c)+vecx*s
    R33 = c+(1-c)*vecz**2
...
def scene_angle(vecx,vecy,vecz,theta):
    """
    入力：x軸,y軸,z軸,回転角
    出力：x軸,y軸,z軸
    """
